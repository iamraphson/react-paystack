...
var PaystackButton = function (_a) {
  var text = _a.text,
    ...
    onSuccess = _a.onSuccess,
    onClose = _a.onClose,
    config = __rest(_a, ['text', 'className', 'children', 'onSuccess', 'onClose']);
  ...
  return React.createElement(
    'button',
    {
      className: className,
      onClick: function () {
        return initializePayment({config: config, onSuccess: onSuccess, onClose: onClose});
      },
    },
    text || children,
  );
...
var PaystackProvider = function (_a) {
  var children = _a.children,
    onSuccess = _a.onSuccess,
    onClose = _a.onClose,
    config = __rest(_a, ['children', 'onSuccess', 'onClose']);
  var initializePayment = usePaystackPayment(config);
  return React.createElement(
...
var PaystackConsumerChild = function (_a) {
  var children = _a.children,
    ref = _a.ref;
  var _b = React.useContext(PaystackContext),
    config = _b.config,
...
var PaystackConsumer = React.forwardRef(function (_a, ref) {
  ...
  var onSuccess = paraSuccess
    ? paraSuccess
    : function () {
        return null;
      };
  var onClose = paraClose
    ? paraClose
    : function () {
        return null;
      };
  return React.createElement(
    PaystackProvider,
    __assign({}, others, {onSuccess: onSuccess, onClose: onClose}),
