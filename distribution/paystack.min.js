...
var PayStack = function (_Component) {
  ...
  _createClass(PayStack, [{
    ...
    key: "payWithPaystack",
    value: function payWithPaystack(e) {
      var _this2 = this;
      ...
      var paystackOptions = {
        ...
        callback: function callback(response) {
          _this2.props.callback(response);
        },
    ...
    value: function render() {
      return this.props.embed ? _react2.default.createElement("div", { id: "paystackEmbedContainer", className: this.state.class }) : _react2.default.createElement(
        "span",
        null,
